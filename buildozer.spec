...
title = Ubuntu2404Test

# (str) Package name
package.name = ubuntu2404test

# (str) Package domain (needed for android/ios packaging)
package.domain = org.ubuntu2404
...
requirements = python3==3.11.0,hostpython3==3.11.0,kivy,cython==0.29.33,sdl2_ttf,pillow
